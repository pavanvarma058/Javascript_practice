...
/*
Destructure the keywords property (array) of the first book from the books array into variables called mainKeyword 
 and rest.
The first keyword should be assigned to mainKeyword, and the rest of the keywords should be 
...
function printBookAuthorsCount(title, ...authors) {
  console.log(
    `The boook ${title} has ${authors.length} ${
