...
characters at index 6, 4, 9 and 8. Use bracket notation to access individual characters.
*/
...
Create a function called isContributor that takes an author's name as an argument, and 
returns either true (if he's a contributor) of false (if he's not a contributor). 
The string "(Contributor)" is always the last part of the author's name string.
*/

function isContributor(name) {
  if (name.includes("(Contributor)")) console.log(true);
